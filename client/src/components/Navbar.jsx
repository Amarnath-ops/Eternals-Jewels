...
const Navbar = ({ homePage }) => {
    ...
    return (
        <nav className={`w-full px-4 pt-4 md:px-4 md:pt-6 ${homePage ? "absolute" : "relative"} z-50`}>
            <div className={`bg-white/25 backdrop-blur-md border ${homePage ? "border-white/20" : "border-black/10"} rounded-full px-5 py-3 md:px-8 md:py-4 2xl:px-12 2xl:py-6 flex justify-between items-center shadow-sm w-full max-w-7xl 2xl:max-w-[90%] mx-auto transition-all duration-300`}>
