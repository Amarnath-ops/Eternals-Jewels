...
import { addCategorySchema as categorySchema } from "@/validations/category.schema";
            ...
            <div className="max-w-4xl mx-auto w-full">
                ...
                <FormWrapper onSubmit={handleSubmit(onSubmit)} className="w-full">
                                ...
                                <label className="flex items-center cursor-pointer gap-2 select-none">
                                    <div
                                        className={`w-5 h-5 rounded-full flex items-center justify-center border ${
                                            status === "Listed" ? "border-black" : "border-gray-300"
                                        }`}
                                    >
                                        {status === "Listed" && <div className="w-3 h-3 bg-black rounded-full"></div>}
                                    </div>
                                    <input
                                        type="radio"
                                        name="status"
                                        ...
                                        onChange={() => {
                                            setStatus("Listed");
                                            setValue("isListed", true, { shouldValidate: true });
                                        }}
                                        className="hidden"
                                    />
                                    <span className="text-gray-800">Listed</span>
                                </label>

                                <label className="flex items-center cursor-pointer gap-2 select-none">
                                    <div
                                        className={`w-5 h-5 rounded-full flex items-center justify-center border ${
                                            status === "Unlisted" ? "border-gray-300" : "border-gray-300"
                                        }`}
                                    >
                                        {status === "Unlisted" ? (
                                    ...
                                    <input
                                        ...
                                        onChange={() => {
                                            setStatus("Unlisted");
                                            setValue("isListed", false, { shouldValidate: true });
                                        }}
                                        className="hidden"
                                    />
                                    <span className="text-gray-800">Unlisted</span>
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mt-8 md:mt-10 flex justify-center md:justify-end pb-8">
                        ...
                        disabled={isPending}
                            type="submit"
                            className="w-full md:w-auto bg-black text-white px-8 py-3 rounded-lg font-medium hover:bg-gray-800 transition shadow-lg"
                        >
