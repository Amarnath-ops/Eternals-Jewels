...
import { useCreateOffer } from "@/hooks/tanstack_Queries/admin/offer/useOfferMutations";
...
const AddOffer = () => {
    ...
    const { mutate: createOffer, isLoading: isCreating } = useCreateOffer();
        ...
        <div className="p-6 max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
                <div className="bg-gray-50 px-8 py-6 border-b border-gray-200">
                    ...
                    <p className="text-gray-500 text-sm mt-1">Define a discount profile that can be applied to products or categories later.</p>
                </div>
