...
import { emailSchema, OtpSchema } from "@/schema/signup.schema";
                    ...
                    <form onSubmit={emailForm.handleSubmit(onSubmitEmail)}>
                        ...
                        <div className="flex">
                            ...
                            disabled={emailEdit}
                                ...
                                className={`grow bg-white text-gray-800 rounded-s-lg px-6 py-3.5 outline-none placeholder-gray-500 shadow-sm focus:ring-2 focus:ring-gray-300 transition-all ${emailEdit?"cursor-not-allowed":""}`}
                                {...emailForm.register("email")}
                            />
                            <button
                                className={`bg-[#c8966a] hover:bg-[#977353] text-white px-6 py-3.5 rounded-e-lg font-medium text-sm shadow-sm transition-colors whitespace-nowrap ${emailEdit?"cursor-not-allowed":""}`}
                                type="submit"
                                disabled={emailEdit}
                            >
                                Send OTP
