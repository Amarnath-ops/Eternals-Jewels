export const ERROR_MESSAGES = Object.freeze({
    ...
    COUPON_CODE_ALREADY_EXISTS: "Coupon with this code already exists",
    COUPON_NOT_FOUND: "Coupon not found",
    COUPON_UPDATE_ERROR: "Failed to update coupon",
    COUPON_STATUS_UPDATE_ERROR: "Failed to update coupon status",
    COUPON_DELETE_ERROR: "Failed to delete coupon", 
    EXPIRY_DATE_MUST_BE_IN_FUTURE: "Expiry date must be in the future",
    EXPIRY_DATE_MUST_BE_AFTER_START_DATE: "Expiry date must be after the start date",
    COUPON_CODE_AND_TOTAL_AMOUNT_REQUIRED: "Coupon code and total amount are required",
    ...
    OFFER_TYPE_REQUIRED: "Offer type is required",
    WALLET_NOT_FOUND: "Wallet not found",
    PAYMENT_METHOD_NOT_RAZORPAY: "Payment method is not RazorPay",
    PAYMENT_ALREADY_COMPLETED: "Payment is already completed",
    USER_VALIDATION_FAILED_FOR_COUPON: "User validation failed for coupon.",
